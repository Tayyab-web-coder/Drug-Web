...
for (let i of testiomnialData) slideHolder.innerHTML += `<div class="swiper-slide"> <div class="ImgHolder"><img src="${i.avatar}" alt='TestimonailImg'></div><div class="ContentHolder"><h2>${i.name}</h2><p>${i.review}</p></div></div>`
